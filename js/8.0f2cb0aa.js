...
`));let l,u,d,m,g,p,_,h,f,$,D=e=>e;const b=s()(l||(l=D`
...
`));n("ffd6");let I,N,R,U,O,L,Q,z,B,Y,M,J,P,F,E,j=e=>e;const A=s()(I||(I=j`
  mutation(
    $username: String
    $fullname: String
    $password: String
